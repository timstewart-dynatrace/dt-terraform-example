...
- Completed: `PHASE-01-done.md` (best-practices conformance), `PHASE-02-done.md` (combined auth + dependency refresh), `PHASE-03-done.md` (pytest coverage + CI)
- To start new work: Create `PHASE-04-active.md`
